    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <form class="form-horizontal" method="post" name="signup" id="signup" enctype="multipart/form-data" >
                ...
                <div class="form-group">
                    <div class="col-xs-offset-3 col-md-8 col-sm-9"><span class="text-muted"><span class="label label-danger">Note:-</span> By clicking Sign Up, you agree to our <a href="termsCondition.php">Terms</a> and that you have read our <a href="termsCondition.php">Policy</a>, including our <a href="termsCondition.php">Cookie Use</a>.</span> </div>
                </div>
                <div class="form-group">
