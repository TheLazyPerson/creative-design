      ...
      <div class="container topPosition">
        <div class="row">
          <div class="col-sm-3 col-xs-6 showcaseBorder smallBottomMargin">
            <img src="images/block1.jpg" class="img-responsive minHeigth600"   >
          </div>
          <div class="col-sm-6 smallBottomMargin">
            <div class="col-sm-6 col-xs-6 nopaddingleft marginbottom15">
              <img src="images/block2.jpg" class="img-responsive minHeigth300 showcaseBorder " >
            </div>
            <div class="col-sm-6 col-xs-6 nopaddingleft noRightPadding">
              <img src="images/block4.png" class="img-responsive minHeigth300 showcaseBorder paddingright20" >
            </div>
            <div class="col-sm-12 col-sm-12 nopaddingleft noRightPadding">
              <img src="images/block3.png" class="img-responsive minHeigth300 showcaseBorder"   >
            </div>
          </div>
          <div class="col-sm-3  nopaddingleft">
            <div class="col-sm-12 col-xs-6 nopaddingleft marginbottom15 noRightPadding">
              <img src="images/Home-Page_03.jpg" class="img-responsive minHeigth300 showcaseBorder " >
            </div>
            <div class="col-sm-12 col-xs-6 nopaddingleft noRightPadding">
              <img src="images/Home-Page_03.jpg" class="img-responsive minHeigth300 showcaseBorder paddingright20" >
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="col-sm-3">
              <!--  <div class=" " style="padding-right:0px;"> -->
                  ...
                  <div class=" BlogContent blogImage1"> 
                     ...
                     <h5 style="line-height: 1.42857143;"  class="text-left paddingbottom10">5mm Brass, Letters Waterjet
                     Cutting with brass.Letters Waterjet
                     Cutting with brass. color yellow. thiknes 1.2inch</h5>
