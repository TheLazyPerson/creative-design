		...
		<section class="margintop30">
			<div class="row">
				...
				<div class="col-sm-7 proComtent"> 
					...
					<br />
					<br />
					<div class="col-sm-6 shouldBeHidden">
						<h4>Max. Characters/row: <span class="product-max-characters"></span></h4>
					</div>
					...
					<table class="table table-bordered tablepadding ">
					  <tbody>    
					    <tr>
					      <td class="col-sm-2 onlyPaddingRight black">Length</td>
					...
					<table class="table table-bordered">
					  <tbody>
					    <tr>
					      <td class="col-md-12">
					      	<div class="col-md-2 black">Note:</div>
